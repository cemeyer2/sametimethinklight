 ...
 * @version 2012.10.09
 */
public class SametimeGoogleVoicePlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "SametimeGoogleVoice";

	// The shared instance
	private static SametimeGoogleVoicePlugin plugin;
	
	//name of the file that will store the preference values
	private static final String PROPERTIES_FILE_NAME = "SametimeGoogleVoice.properties";

	//building blocks
	private static final String PREFIX = "com.ibm.lnja.SametimeGoogleVoice";
	 ...
	 * The constructor
	 */
	public SametimeGoogleVoicePlugin() {
//		debug("Activator instantiated");
	 ...
	 */
	public static SametimeGoogleVoicePlugin getDefault() {
		return plugin;
	}
